## 11.0.0
 ...
 - Feat: always check ES license [#1005](https://github.com/logstash-plugins/logstash-output-elasticsearch/pull/1005)
   To align with Elasticsearch no longer providing a separate OSS artifact, the plugin will always expect a valid license, 
   regardless of the Logstash we're running on.
