...
The indexing target to write events to. Can point to an <<https://www.elastic.co/guide/en/elasticsearch/reference/current/index-mgmt.html,index>>, <<https://www.elastic.co/guide/en/elasticsearch/reference/current/aliases.html,alias>>, or <<https://www.elastic.co/guide/en/elasticsearch/reference/current/data-streams.html,data stream>>. 
