...
Whem using Logstash 7.9+, this setting supports defining an environment variable
`hosts => '${ES_HOSTS:}' with multiple {logstash-ref}/plugin-concepts.html[whitespace-delimited URIs], e.g.:
