...
For Elasticsearch 1.x and 2.x any nodes with `http.enabled` (on by default) will be added to the hosts list, including master nodes!
For Elasticsearch 5.x and 6.x only nodes with the data role enabled will be added to the hosts list.
