...
| <<plugins-{type}s-{plugin}-absolute_healthcheck_path>> |<<boolean,boolean>>|No
| <<plugins-{type}s-{plugin}-absolute_sniffing_path>> |<<boolean,boolean>>|No
...
[id="plugins-{type}s-{plugin}-absolute_healthcheck_path"]
...
[id="plugins-{type}s-{plugin}-absolute_sniffing_path"]
