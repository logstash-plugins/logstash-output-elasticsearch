...
to prevent LS from sending bulk requests to the master nodes.  So this parameter should only reference either coordinating, ingest or data nodes in Elasticsearch.
