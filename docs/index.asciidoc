...
This setting asks Elasticsearch for the list of all cluster nodes and adds the data serving nodes to the hosts list.
Note: This will skip nodes that do not have the data role enabled (ie. master only nodes).
